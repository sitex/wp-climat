...
if (have_posts()) : while (have_posts()) : the_post();
	...
	$params = getParams(the_title('', '', false));
?>
		...
		<div class="page_caption">
			<div class="caption_inner">
				<div class="caption_header">
					<h1 class="cufon"><?php echo $params['title']; ?></h1>
				</div>
			</div>
...
?>
						...
						<div class="post_wrapper" <?php if($cur_post==$num_of_posts) { echo 'style="margin-bottom:0"'; }?>>
							...
							<br class="clear"/>
						    <p>
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/timthumb.php?src=<?php echo $image_thumb[0]; ?>&w=<?php echo $pp_blog_image_width; ?>&zc=1" alt=""/>
						    </p>
							<br/><br/>
